...
const Header = () => {
  return (
    <header className="align-element py-2">
      <section className="bg-darkGreen20 py-1 rounded-lg shadow-xl flex flex-col lg:flex-row justify-between items-center">
        <div className="hidden lg:flex">
          <img src={headerLeft} alt="" />
        </div>
        <div className="flex items-center justify-center gap-3">
          <img src={cricket} alt="" />
          <h1 className="text-white text-xs lg:text-lg">
